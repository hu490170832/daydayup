...
* [安装 nuxt.js](#开始)
* [Nuxt 常用配置项](#nuxt-常用配置项)
* [Nuxt 的路由配置和参数传递](#nuxt-路由配置和参数传递)
* [Nuxt 的动态路由和参数校验](#nuxt-动态路由和参数校验)
* [Nuxt 的路由动画效果](#nuxt-路由动画效果)
* [Nuxt 的默认模版和默认布局](#nuxt-默认模版和默认布局)
* [Nuxt 的错误页面和个性meta设置](#nuxt-错误页面和个性meta设置)
* [asyncData 方法获取数据](#asyncdata-方法获取数据)
